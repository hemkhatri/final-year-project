...
from .views import (
    ...
    SellerOrdersJsonView, category_list_view, become_seller_view, become_seller_landing, privacy_policy, careers_landing, product_search_view, autocomplete_search_view
)
